  ...
  Employee* authorization() {
    ...
    while (true) {
      ...
      if (it != users.end() && it->second.first == inputPassword) {
        std::cout << "Autoristion complete!" << std::endl;
...
// editor-in-chief
vector<string> menu3 = {"Create article", "View current articles in the editorial office", "Articles for approval",
                        "Exit", ""};
...
// lit editor
vector<string> menu5 = {"View editorial articles", "Exit", ""};
